...
class TestQmoneyAPILogin:
  ...
  def test_logging_in_to_qmoney(self, qmoney_url, qmoney_credentials,
                                qmoney_token):
    response = QMoney.login(qmoney_url, qmoney_credentials, qmoney_token, True)
  ...
  def test_failing_at_logging_in_to_qmoney_when_wrong_username(
    ...
    response = QMoney.login(qmoney_url, ['username', qmoney_credentials[1]],
                            qmoney_token, True)
  ...
  def test_failing_at_logging_in_to_qmoney_when_wrong_password(
    ...
    response = QMoney.login(qmoney_url, [qmoney_credentials[0], 'password'],
                            qmoney_token, True)
